...
//        this.conn = conn;
//        this.medicalRecordDAO = new MedicalRecordDAO(conn);
//    }
//
...
//
//                    // Calculate subtotal, tax, discount from total (assuming tax rate 10% and
//                    // discount 5%)
//                    // This is a simplification - in real scenario, these should be stored
//                    // separately
...
//            ps.setInt(1, invoice.getMedicalRecord().getId());
...
//                if (serviceId > 0) {
//                    ps.setInt(1, invoice.getMedicalRecord().getPatient().getId());
