# Giới thiệu phần mềm quản lý hồ sơ bệnh án
Phần mềm quản lý hồ sơ bệnh án là một ứng dụng được xây dựng bằng Java nhằm hỗ trợ bệnh viện, phòng khám quản lý dữ liệu bệnh nhân một cách hiệu quả, an toàn và tiện lợi.
Chức năng chính:
